...
namespace Оконное_приложение
{
    public partial class Form1 : Form
    {
        ...
        public void button1_Click(object sender, EventArgs e)
        {
            ...
            DialogResult res = MessageBox.Show("Вариант создан", "Информация", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
...
namespace kukuha2
    {
        public partial class kukuha
        {
            ...
            static private void var1(int i, ref List<string> all_key, Microsoft.Office.Interop.Word.Application winword, Document document)
            {
                ...
                all_key.Add(key);
                document.Content.InsertAfter(otv +
                    "\n\n\n\n15. Соотношением вида P(K < -2,09) = 0,025 можно определить:\n");
                a = "левосторннюю критическую область"; b = "правосторннюю критическую область"; c = "двустороннюю критическую область"; d = "область принятия гипотезы"; key = a;
                otv = otvet(a, b, c, d, ref key);
                all_key.Add(key);
                document.Content.InsertAfter(otv +
                    "\n16. Правосторонняя критическая область может определяться из соотношения:\n");
                ...
                all_key.Add(key);
                document.Content.InsertAfter(otv +
                    "\n18. Выборочное уравнение прямой линии регрессии Y на X имеет вид ȳₓ - 3,25 = 1,245(x+2,14) . Тогда выборочное среднее признака X равно:\n");
                a = "2,14"; b = "-2,14"; c = "2,5"; d = "-2,5"; key = b;
                otv = otvet(a, b, c, d, ref key);
                all_key.Add(key);
                document.Content.InsertAfter(otv +
                ...
                document.Content.InsertAfter(otv +
                    "\n20. При построении выборочного уравнения прямой линии регрессии X на Y вычислены выборочный коэффициент регрессии ρₓᵧ" +
                        " = 3,8 и выборочные средние ֿx  = 13,2 и ȳ = 22,7. Тогда уравнение регрессии примет вид:\n");
                a = "ᅠ ֿxᵧ = 3,8y + 73,06"; b = "ȳₓ = 3,8y + 73,06"; c = "ᅠ ֿxᵧ = 3,8y - 73,06"; d = "ᅠ ֿxᵧ = 3,8y + 80,35"; key = c;
                otv = otvet(a, b, c, d, ref key);
                all_key.Add(key);
                document.Content.InsertAfter(otv +
            ...
            static private void var2(int i, ref List<string> all_key, Microsoft.Office.Interop.Word.Application winword, Document document)
            {
                ...
                all_key.Add(key);
                document.Content.InsertAfter(otv +
                    "\n7. По выборке объема n = 10 найдена выборочная дисперсия DB = 810. Тогда исправленное среднее квадратическое отклонение равно:\n");
                ...
                all_key.Add(key);
                document.Content.InsertAfter(otv +
                    "\n\n\n\n15. Соотношением вида P(K > 1,49) = 0,05 можно определить:\n");
                a = "левосторннюю критическую область"; b = "правосторннюю критическую область"; c = "двустороннюю критическую область"; d = "область принятия гипотезы"; key = b;
                otv = otvet(a, b, c, d, ref key);
                all_key.Add(key);
                document.Content.InsertAfter(otv +
                    "\n16. Правосторонняя критическая область может определяться из соотношения:\n");
                ...
                all_key.Add(key);
                document.Content.InsertAfter(otv +
                    "\n18. Выборочное уравнение прямой линии регрессии Y на X имеет вид ȳₓ - 2,14 = 2,113(x+1,53). Тогда выборочное среднее признака X равно:\n");
                ...
                document.Content.InsertAfter(otv +
                    "\n20. При построении выборочного уравнения прямой линии регрессии X на Y вычислены выборочный коэффициент регрессии ρₓᵧ" +
                        " = 3,6 и выборочные средние  ֿx = 24,9 и ȳ = 12,5 . Тогда уравнение регрессии примет вид:\n");
                a = "ᅠ ֿxᵧ = 3,6y - 77,14"; b = "ᅠ -ֿxᵧ = 3,6y + 77,14"; c = "ᅠ -ֿxᵧ = 3,6y - 100,14"; d = "ȳₓ = 3,6x - 77,14"; key = a;
                otv = otvet(a, b, c, d, ref key);
                all_key.Add(key);
                document.Content.InsertAfter(otv +
                    "\n21. При построении выборочного уравнения парной регрессии вычислены выборочный коэффициент корреляции rᵦ = – 0, 56 выборочные средние " +
            ...
            static private void var3(int i, ref List<string> all_key, Microsoft.Office.Interop.Word.Application winword, Document document)
            {
                ...
                all_key.Add(key);
                document.Content.InsertAfter(otv +
                    "\n7. По выборке объема n = 10 найдена выборочная дисперсия DB = 65610. Тогда исправленное среднее квадратическое отклонение равно:\n");
                a = "0,9"; b = "3"; c = "9"; d = "81"; key = d;
                otv = otvet(a, b, c, d, ref key);
                all_key.Add(key);
                document.Content.InsertAfter(otv +
                    "\n8. Из генеральной совокупности извлечена выборка объема n = 500, гистограмма частот которой имеет вид:");
                ...
                all_key.Add(key);
                document.Content.InsertAfter(otv +
                    "\n\n\n\n15. Соотношением вида P(K < -2,78) + P(K > 2,78) = 0,01 можно определить:\n");
                a = "левосторннюю критическую область"; b = "правосторннюю критическую область"; c = "двустороннюю критическую область"; d = "область принятия гипотезы"; key = c;
                otv = otvet(a, b, c, d, ref key);
                all_key.Add(key);
                document.Content.InsertAfter(otv +
                    "\n16. Правосторонняя критическая область может определяться из соотношения:\n");
                ...
                all_key.Add(key);
                document.Content.InsertAfter(otv +
                    "\n18. Выборочное уравнение прямой линии регрессии Y на X имеет вид ȳₓ - 4,8 = 0,53(x-3,13). Тогда выборочное среднее признака X равно:\n");
                ...
                document.Content.InsertAfter(otv +
                    "\n20. При построении выборочного уравнения прямой линии регрессии X на Y вычислены выборочный коэффициент регрессии ρₓᵧ" +
                        " = -2,45 и выборочные средние ֿx  = 3,44 и ȳ = 7,18. Тогда уравнение регрессии примет вид:\n");
                a = "ᅠ ֿxᵧ = 2,45y + 15,608"; b = "ȳₓ = -2,45y + 15,608"; c = "ȳₓ = -2,45y + 1,248"; d = "ȳₓ = -2,45y - 15,608"; key = b;
                otv = otvet(a, b, c, d, ref key);
                all_key.Add(key);
                document.Content.InsertAfter(otv +
                    "\n21. При построении выборочного уравнения парной регрессии вычислены выборочный коэффициент корреляции rᵦ = – 0, 56 выборочные средние " +
            ...
            static private void var4(int i, ref List<string> all_key, Microsoft.Office.Interop.Word.Application winword, Document document)
            {
                ...
                all_key.Add(key);
                document.Content.InsertAfter(otv +
                    "\n7. По выборке объема n = 10 найдена выборочная дисперсия DB = 90. Тогда исправленное среднее квадратическое отклонение равно:\n");
                ...
                all_key.Add(key);
                document.Content.InsertAfter(otv +
                    "\n\n\n\n15. Соотношением вида P(K > 2,78) = 0,05 можно определить:\n");
                a = "левосторннюю критическую область"; b = "правосторннюю критическую область"; c = "двустороннюю критическую область"; d = "область принятия гипотезы"; key = b;
                otv = otvet(a, b, c, d, ref key);
                all_key.Add(key);
                document.Content.InsertAfter(otv +
                ...
                all_key.Add(key);
                document.Content.InsertAfter(otv +
                    "\n18. Выборочное уравнение прямой линии регрессии Y на X имеет вид ȳₓ - 1,5 = 3,14(x-2,41). Тогда выборочное среднее признака X равно:\n");
                ...
                document.Content.InsertAfter(otv +
                    "\n20. При построении выборочного уравнения прямой линии регрессии X на Y вычислены выборочный коэффициент регрессии ρₓᵧ" +
                        " = 1,53 и выборочные средние ֿx = 8,9 и ȳ = 13,7. Тогда уравнение регрессии примет вид:\n");
                a = "ᅠֿxᵧ = 1,53y - 12,061"; b = "ᅠֿxᵧ = - 1,53y - 12,061"; c = "ᅠֿxᵧ = -1,53y + 12,061"; d = "ᅠֿxᵧ = 1,53y + 15,061"; key = a;
                otv = otvet(a, b, c, d, ref key);
                all_key.Add(key);
                document.Content.InsertAfter(otv +
